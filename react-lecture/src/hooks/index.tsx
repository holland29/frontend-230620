...
// reducer 함수 정의
// : 변화를 일으키는 함수
// : 두 가지 파리미터를 받아, 현재 상태와 전달받은 액션을 참고하여 새로운 상태를 만들어서 반환
function reducer(state: typeof initialState, action: Action) {
    ...
    // 'REMOVE_USER': 전체 user에서 user.id와 action.id가 동일하지 않다는 조건을 만족할 경우 
...
export default function Index() {
    ...
    // useReducer: const[state, dispatch] = useReducer(reducer함수, intialState);
